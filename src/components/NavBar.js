        ...
        ">
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    ...
                    <motion.a href="https://Github.com" target={"_blank"} className="w-6 mx-3"
                        whileHover={{ y: -3 }}
                        whileTap={{ scale: 0.9 }}
                    ...
                    <motion.a href="https://Linked.com" target={"_blank"} className="w-6 mx-3"
                        whileHover={{ y: -3 }}
                        whileTap={{ scale: 0.9 }}
         ...
         ">
          ...
          items-center flex-col justify-center">
                            <CustomMobilLink href="/" title="Home" className='mr-4' toggle={handleClick} />
                            <CustomMobilLink href="/about" title="About" className='mx-4' toggle={handleClick} />
                            <CustomMobilLink href="/projects" title="Projects" className='mx-4' toggle={handleClick} />
                            <CustomMobilLink href="/articles" title="Articles" className='ml-4' toggle={handleClick} />
